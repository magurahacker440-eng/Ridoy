...
const cuteReplies = [
  "I love you 💝",
  "এ বেডা তোগো GC এর C E O রিদয় কই😌",
  "ভালোবাসা দিবি🤨নাকি আকিজ বিড়ি খেয়ে মরে যাবো ",
  "Bot না জানু,বল 😌",
  "বলো জানু 🌚",
  "তোর কি চোখে পড়ে না আমি রিদয় বস এর সাথে ব্যাস্ত আসি😒",
  "𝙏𝙢𝙧 𝙣𝙖𝙣𝙞 𝙧 𝐨𝐢 𝐭𝐚  😑🥺",
  ...
  "bye", "naw message daw m.me/ r.i.d.o.y.tsu.863539", "mb ney bye", "meww", "আজ পাঁচ দিন, হলো আমি নামাজ পড়ি?🤭🤏",
  "𝗜 𝗹𝗼𝘃𝗲 𝘆𝗼𝘂__😘😘", "𝗜 𝗵𝗮𝘁𝗲 𝘆𝗼𝘂__😏😏", "গোসল করে আসো যাও😑😩", "আসসালামু আলাইকুম ", "কেমন আসো",
  "বলেন sir__😌", "বলেন ম্যাডাম__😌", "কেও আমাকে ধাক্কা দিয়া প্রেমের সাগরে ফেলাই দে😫যেই গরম পড়ছে একটু সাতার কাটতাম আরকি😬🏊‍♀️", "🙂🙂🙂", "তুমি সুন্দর না দূরে থাকো_🙂🙂🙂",
  ...
  "আমি তো অন্ধ কিছু দেখি না🐸 😎", "লুঙ্গি ঢিলা প্লাজু টাইট, সবাইকে জানাই গুড নাইট 😒🫣", "𝗼𝗶𝗶 ঘুমানোর আগে.! তোমার মনটা কথায় রেখে ঘুমাও.!🤔_নাহ মানে চুরি করতাম 😞😘",
  "𝗕𝗼𝘁 না বলে 𝗕𝗼𝘄 বলো 😘", "দূরে যা, তোর কোনো কাজ নাই, শুধু 𝗕𝗼𝘁 𝗕𝗼𝘁 করিস  😉😋🤣", "প্রেম নাই কপালে কথা হবে সকালে 🥱😾", 
  "তোরা যে হারে 𝗕𝗼𝘁 ডাকছিস আমি তো সত্যি ভাইরাল হয়ে যাবো_☹😑", "আজব তো__😒", "আমাকে ডেকো না,আমি ব্যাস্ত আসি🙆🏻‍♀️", "𝗕𝗼𝘁 বললে চাকরি থাকবে না", 
  "𝗕𝗼𝘁 𝗕𝗼𝘁 না করে আমার বস রিদয় এর লগে প্রেম করতে পারো😑?", "আমার সোনার বাংলা, তারপরে লাইন কি? 🙈", "🍺 এই নাও জুস খাও..!𝗕𝗼𝘁 বলতে বলতে হাপায় গেছো না 🥲",
  "হটাৎ আমাকে মনে পড়লো 🙄", "𝗕𝗼𝘁 বলে অসম্মান করচ্ছিছ,😰😿", "ভাইয়া ডাকার আগে 😼ভাবি খুজে দিবি🙁নাহলে খবর আছে😎", "খাওয়া দাওয়া করসো 🙄", 
  ...
  "amr JaNu lagbe,Tumi ki single aso?", "আমাকে না দেকে একটু পড়তেও বসতে তো পারো 🥺🥺", "জান একটা Kiss 💋 দিবা,,🙄", 
